...
interface VolumeChanger {
  updateVolumeFromPose: (pose: NormalizedLandmarkList, volumeNode: Tone.Volume | null) => void;
}
...
export const useVolumeChanger = (): VolumeChanger => {
  ...
  const updateVolumeFromPose = useCallback((currentPose: NormalizedLandmarkList, volumeNode: Tone.Volume | null) => {
